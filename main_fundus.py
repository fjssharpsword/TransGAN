...
from datasets.fundus_idrid_grading import get_dataset_fundus
...
if __name__ == "__main__":
    ...
    #model define
    transenc = TransEnc(args.size, args.mlp_dim).to(device)
    cnnsenc = CNNEnc(args.size, args.mlp_dim).to(device)
    ...
    #nohup python -m torch.distributed.launch --nproc_per_node=8 main_fundus.py > logs/train.log 2>&1 &
    #nohup python main_fundus.py > logs/train.log 2>&1 &